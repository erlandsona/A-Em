...
var _erlandsona$a_em$Caldwell_Types_UI$Contact = {ctor: 'Contact'};
var _erlandsona$a_em$Caldwell_Types_UI$About = {ctor: 'About'};
var _erlandsona$a_em$Caldwell_Types_UI$Shows = {ctor: 'Shows'};
var _erlandsona$a_em$Caldwell_Types_UI$Music = {ctor: 'Music'};
var _erlandsona$a_em$Caldwell_Types_UI$Home = {ctor: 'Home'};
var _erlandsona$a_em$Caldwell_Types_UI$SetUrl = function (a) {
	return {ctor: 'SetUrl', _0: a};
};
var _erlandsona$a_em$Caldwell_Types_UI$GoToUrl = function (a) {
	return {ctor: 'GoToUrl', _0: a};
};
var _erlandsona$a_em$Caldwell_Types_UI$ToggleNav = function (a) {
	return {ctor: 'ToggleNav', _0: a};
};

var _erlandsona$a_em$Caldwell_Helpers$prop = _rtfeldman$elm_css$Css$property;
var _erlandsona$a_em$Caldwell_Helpers$clickWithStopProp = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		A2(_elm_lang$html$Html_Events$Options, true, false),
		_elm_lang$core$Json_Decode$succeed(msg));
};
var _erlandsona$a_em$Caldwell_Helpers$translatify = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'Music':
			return '1';
...
var _erlandsona$a_em$Caldwell_Helpers$paginate = function (page) {
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				...
				_1: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_erlandsona$a_em$Caldwell_Helpers$translatify(page),
						'00%)'))
			},
			_1: {ctor: '[]'}
		});
};
var _erlandsona$a_em$Caldwell_Helpers$urlParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_erlandsona$a_em$Caldwell_Types_UI$Music,
			_evancz$url_parser$UrlParser$s('music')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_erlandsona$a_em$Caldwell_Types_UI$Shows,
				_evancz$url_parser$UrlParser$s('shows')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_erlandsona$a_em$Caldwell_Types_UI$About,
					_evancz$url_parser$UrlParser$s('about')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_erlandsona$a_em$Caldwell_Types_UI$Contact,
...
var _erlandsona$a_em$Caldwell_Helpers$drawer = A2(
	_elm_lang$html$Html$node,
	'drawer',
	{ctor: '[]'});
var _erlandsona$a_em$Caldwell_Helpers$container = _elm_lang$html$Html$node('container');

var _erlandsona$a_em$Caldwell_Model$parsePage = function (loc) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_erlandsona$a_em$Caldwell_Types_UI$Home,
		A2(_evancz$url_parser$UrlParser$parsePath, _erlandsona$a_em$Caldwell_Helpers$urlParser, loc));
};
var _erlandsona$a_em$Caldwell_Model$init = function (location) {
	var model = {
		history: {
			ctor: '::',
			_0: _erlandsona$a_em$Caldwell_Model$parsePage(location),
			_1: {ctor: '[]'}
		},
		navOpen: false
	};
...
var _erlandsona$a_em$Caldwell_Model$Model = F2(
	function (a, b) {
		return {history: a, navOpen: b};
	});

var _erlandsona$a_em$Caldwell_UI_Header$view = function (bool) {
	return A2(
		_elm_lang$html$Html$header,
		{
			ctor: '::',
			_0: _erlandsona$a_em$Caldwell_Helpers$clickWithStopProp(
				_erlandsona$a_em$Caldwell_Types_UI$ToggleNav(bool)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Caldwell'),
			_1: {ctor: '[]'}
		});
};

var _erlandsona$a_em$Caldwell_UI_Nav$aTag = function (page) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_erlandsona$a_em$Caldwell_Types_UI$SetUrl(page)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _erlandsona$a_em$Caldwell_UI_Nav$view = function (bool) {
	return A2(
		...
		{
			ctor: '::',
			_0: _erlandsona$a_em$Caldwell_UI_Nav$aTag(_erlandsona$a_em$Caldwell_Types_UI$Home),
			_1: {
				ctor: '::',
				_0: _erlandsona$a_em$Caldwell_UI_Nav$aTag(_erlandsona$a_em$Caldwell_Types_UI$Music),
				_1: {
					ctor: '::',
					_0: _erlandsona$a_em$Caldwell_UI_Nav$aTag(_erlandsona$a_em$Caldwell_Types_UI$Shows),
					_1: {
						ctor: '::',
						_0: _erlandsona$a_em$Caldwell_UI_Nav$aTag(_erlandsona$a_em$Caldwell_Types_UI$About),
						_1: {
							ctor: '::',
							_0: _erlandsona$a_em$Caldwell_UI_Nav$aTag(_erlandsona$a_em$Caldwell_Types_UI$Contact),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _erlandsona$a_em$Caldwell_UI_Main$view = function (page) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$section,
				{
					...
					_1: {
						ctor: '::',
						_0: _erlandsona$a_em$Caldwell_Helpers$paginate(page),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('Music'),
						_1: {
							ctor: '::',
							_0: _erlandsona$a_em$Caldwell_Helpers$paginate(page),
							_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('Shows'),
							_1: {
								ctor: '::',
								_0: _erlandsona$a_em$Caldwell_Helpers$paginate(page),
								_1: {ctor: '[]'}
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Shows'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Stuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and thingsStuff and things'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _erlandsona$a_em$Caldwell_View$view = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.navOpen;
	return A2(
		_erlandsona$a_em$Caldwell_Helpers$container,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_erlandsona$a_em$Caldwell_Types_UI$ToggleNav(true)),
			_1: {
				ctor: '::',
		...
		{
			ctor: '::',
			_0: _erlandsona$a_em$Caldwell_UI_Header$view(_p2),
			_1: {
				ctor: '::',
				_0: _erlandsona$a_em$Caldwell_UI_Nav$view(_p2),
				_1: {
					ctor: '::',
					_0: _erlandsona$a_em$Caldwell_UI_Main$view(
						A2(
							_elm_lang$core$Maybe$withDefault,
							_erlandsona$a_em$Caldwell_Types_UI$Home,
							_elm_lang$core$List$head(_p1.history))),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _erlandsona$a_em$Caldwell_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetUrl':
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							navOpen: A2(_elm_lang$core$Debug$log, 'nav', !_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _erlandsona$a_em$Caldwell$parseMsg = function (loc) {
	return _erlandsona$a_em$Caldwell_Types_UI$GoToUrl(
		A2(
			_elm_lang$core$Maybe$withDefault,
			_erlandsona$a_em$Caldwell_Types_UI$Home,
			A2(_evancz$url_parser$UrlParser$parsePath, _erlandsona$a_em$Caldwell_Helpers$urlParser, loc)));
};
var _erlandsona$a_em$Caldwell$main = A2(
	_elm_lang$navigation$Navigation$program,
	_erlandsona$a_em$Caldwell$parseMsg,
	{
		init: _erlandsona$a_em$Caldwell_Model$init,
		view: _erlandsona$a_em$Caldwell_View$view,
		update: _erlandsona$a_em$Caldwell_Update$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Caldwell'] = Elm['Caldwell'] || {};
if (typeof _erlandsona$a_em$Caldwell$main !== 'undefined') {
    _erlandsona$a_em$Caldwell$main(Elm['Caldwell'], 'Caldwell', undefined);
}
